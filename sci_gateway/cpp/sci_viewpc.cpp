...
static const char fname[] = "viewpc";
int sci_viewpc(scilabEnv env, int nin, scilabVar* in, int nopt, scilabOpt* opt, int nout, scilabVar* out)

{
    ...
    // number of inputs should be 1 - the file name
	if (nin != 1)
    {
